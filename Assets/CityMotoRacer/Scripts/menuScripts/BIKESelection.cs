...
public class BIKESelection : MonoBehaviour {
	...
	void showBIKEINFO()
	{
		...
		case 0:
			...
			BIKEPriceDisplayText.text = "ÖDEME  :    ÜCRETSİZ ";
			playButton.SetActive(true);
			buyButton.SetActive(false);
			break;
		case 1:
			...
			BIKEPriceDisplayText.text = "ÖDEME  :     1000 ";
		...
		case 2:
			...
			BIKESpeedDisplayText.text = "TOPLAM HIZ : 130 km/s";
			BIKEPriceDisplayText.text = "ÖDEME  :     3000 ";
		...
		case 3:
			...
			BIKEPriceDisplayText.text = "ÖDEME  :     4000 ";
		...
		case 4:
			...
			BIKEPriceDisplayText.text = "ÖDEME  :     5000 ";
		...
		case 5:
			...
			BIKEPriceDisplayText.text = "ÖDEME  :     7000 ";
